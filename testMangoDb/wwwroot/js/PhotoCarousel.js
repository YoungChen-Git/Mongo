(function($){
    ...
    Carousel.prototype = {
        //设置上一张和下一张大小
        setDirect:function(){
            var prev = $("<div></div>").addClass("content-btn prev-btn").append($("<img/>").attr("src","/images/Carousel_Button/button-left.svg").addClass("btn-img"));//置換按鈕網址
            this.con.prepend(prev);
            var next = $("<div></div>").addClass("content-btn next-btn").append($("<img/>").attr("src","/images/Carousel_Button/button-right.svg").addClass("btn-img"));//置換按鈕網址
